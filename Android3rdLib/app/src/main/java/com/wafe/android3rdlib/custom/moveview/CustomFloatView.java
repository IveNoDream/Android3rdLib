...
public class CustomFloatView extends ImageView {
    ...
    private WindowManager.LayoutParams wmParams = ((WMApplication) getContext().getApplicationContext()).getWMParams();
    ...
    public CustomFloatView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public CustomFloatView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public CustomFloatView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
