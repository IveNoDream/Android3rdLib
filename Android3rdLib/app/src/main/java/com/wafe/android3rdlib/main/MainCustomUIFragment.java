...
import com.wafe.android3rdlib.custom.CustomRVAdapter;
...
public class MainCustomUIFragment extends Fragment {
    ...
    private void init() {
        ...
        mCustomRVAdapter = new CustomRVAdapter(mContext);
        mRecycler.setAdapter(mCustomRVAdapter);
        mCustomRVAdapter.setOnItemClickListner(new CustomRVAdapter.OnItemClickListner() {
            @Override
            public void onItemClick(View view, int position) {
                MainRVDataModel dataModel= MainRVDataFactory.RV_CUSTOM_DATS.get(position);
