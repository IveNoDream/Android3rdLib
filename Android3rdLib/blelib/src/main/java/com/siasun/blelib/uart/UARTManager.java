package com.siasun.blelib.uart;
...
public class UARTManager extends BleManager<UARTManagerCallbacks> {
    ...
    private static UARTManager uartmanagerinstance = null;
    ...
    public static synchronized UARTManager getInstance(final Context context) {
        if (null == uartmanagerinstance) {
            uartmanagerinstance = new UARTManager(context);
        }
